...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-indigo-50/20 to-fuchsia-50/20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-xl p-8 border border-slate-200/80 rounded-3xl shadow-xl shadow-slate-100/50 relative z-10">
        <div>
          ...
          <h2 className="mt-6 text-center text-3xl font-extrabold tracking-tight text-slate-900 bg-clip-text bg-gradient-to-r from-slate-900 to-indigo-950">
            Scholar Tracker
          </h2>
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5 ml-1">
                ...
                <Link
                  ...
                  className="text-[10px] font-bold text-indigo-650 hover:text-indigo-700 transition-colors"
                >
                  Oublié ?
                </Link>
              </div>
